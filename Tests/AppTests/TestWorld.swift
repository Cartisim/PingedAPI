...
class TestWorld {
    ...
    init(app: Application) throws {
        ...
        app.config = .init(frontendURL: "http://frontend.local", apiURL: "http://api.local", noReplyEmail: "no-reply@testing.local", hostname: "hostname", username: "username", password: "password", database: "database", jwksKeypairFile: "jwksKeypairFile", adminName: "adminName", adminEmail: "adminEmail", adminPassword: "adminPassword")
    }
}
